      ...
      <div className="Home">
        <div className="pure-g">
            ...
            <div className="text-box pure-u-1 pure-u-md-1-2 pure-u-lg-2-3">
                <div className="l-box">
                    <h1 className="text-box-head">BotMaker</h1>
                    <p className="text-box-subhead">Create and sell your own unique robots which live on the blockchain. Have them send signals to physical robots on the Internet of Things</p>
                </div>
            </div>
